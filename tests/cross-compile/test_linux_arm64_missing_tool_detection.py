"""
Property-based test for missing tool detection in the Linux ARM64 build script.

Feature: linux-arm64-cross-compile, Property 2: Missing tool detection
    ...
    **Validates: Requirements 4.1, 4.2, 4.6, 4.7**
    ...
    def test_missing_zig(self, work_dir, mock_bin):
        ...
        **Validates: Requirements 4.1, 4.2**
        """
        # Build a restricted PATH with only coreutils + cmake (no zig)
    ...
    def test_missing_moc(self, work_dir, mock_bin):
        ...
        **Validates: Requirements 4.6, 4.7**
        ...
        # Linux ARM64 Qt: needs lib/cmake/Qt6 to exist so variant
        # resolution passes
        arm64_qt = qt_base / "gcc_arm64"
        (arm64_qt / "lib" / "cmake" / "Qt6").mkdir(parents=True)

        # Linux x86_64 Qt: directory exists (so download is skipped)
